    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {dayAggregates.tradeCount} trade
            {dayAggregates.tradeCount !== 1 ? "s" : ""} closed on this day
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="space-y-1">
              ...
              <p
                className={`text-2xl font-bold ${dayAggregates.totalPLDollar >= 0 ? "text-green-500" : "text-red-500"}`}
              >
            ...
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">Total P/L (%)</p>
              <p
                className={`text-2xl font-bold ${dayAggregates.totalPLPercent >= 0 ? "text-green-500" : "text-red-500"}`}
              >
                {dayAggregates.totalPLPercent >= 0 ? "+" : ""}
                {dayAggregates.totalPLPercent.toFixed(1)}%
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p
                className={`text-2xl font-bold ${dayAggregates.netR >= 0 ? "text-green-500" : "text-red-500"}`}
              >
                {dayAggregates.netR >= 0 ? "+" : ""}
                {dayAggregates.netR.toFixed(2)}R
              </p>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <p
                      className={`text-lg font-bold ${tradePL >= 0 ? "text-green-500" : "text-red-500"}`}
                    >
                      ${tradePL.toFixed(2)}
                    </p>
